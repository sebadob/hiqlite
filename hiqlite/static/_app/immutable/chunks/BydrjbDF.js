...
function j(t) {
  ...
  var e = /* @__PURE__ */ new Map(), r = hn(t), s = N(0), a = v, f = (u) => {
    var l = v;
    B(a);
    var i = u();
    return B(l), i;
  ...
  return r && e.set("length", N(t.length)), new Proxy(t, { defineProperty(u, l, i) {
    ...
    if (i && "value" in i) {
      ...
      var o = e.get(l), _ = o == null ? void 0 : o.v;
    ...
    var _a;
    var o = e.get(l), _ = l in u;
    if (r && l === "length") for (var G = i; G < o.v; G += 1) {
      var nt = e.get(G + "");
      nt !== void 0 ? D(nt, w) : G in u && (nt = f(() => N(w)), e.set(G + "", nt));
    }
    o === void 0 ? (!_ || ((_a = $(u, l)) == null ? void 0 : _a.writable)) && (o = f(() => N(void 0)), D(o, f(() => j(i))), e.set(l, o)) : (_ = o.v !== w, D(o, f(() => j(i))));
    var Ot = Reflect.getOwnPropertyDescriptor(u, l);
    if ((Ot == null ? void 0 : Ot.set) && Ot.set.call(c, i), !_) {
      if (r && typeof l == "string") {
...
function D(t, n, e = false) {
  v !== null && !A && pt() && (v.f & (T | bt)) !== 0 && !(I == null ? void 0 : I.includes(t)) && Nn();
  let r = e ? j(n) : n;
  return Fn(t, r);
}
function Fn(t, n) {
...
function Xt(t) {
  d === null && v === null && An(), v !== null && (v.f & g) !== 0 && d === null && xn(), X && Tn();
}
function qn(t, n) {
  var e = n.last;
...
function V(t, n, e, r = true) {
  ...
  if (!f && r && (s !== null && qn(a, s), v !== null && (v.f & T) !== 0)) {
    var u = v;
...
let I = null;
function fn(t) {
  v !== null && v.f & Et && (I === null ? I = [t] : I.push(t));
}
...
function vn(t) {
  var _a;
  var n = h, e = E, r = b, s = v, a = S, f = I, u = p, l = A, i = t.f;
  h = null, E = 0, b = null, S = (i & g) !== 0 && (A || !C || v === null), v = (i & (R | U)) === 0 ? t : null, I = null, Dt(t.ctx), A = false, ot++, t.f |= Et;
  try {
    var c = (0, t.fn)(), o = t.deps;
    if (h !== null) {
      var _;
      if (ct(t, E), o !== null && E > 0) for (o.length = E + h.length, _ = 0; _ < h.length; _++) o[E + _] = h[_];
      else t.deps = o = h;
      if (!S) for (_ = E; _ < o.length; _++) ((_a = o[_]).reactions ?? (_a.reactions = [])).push(t);
    } else o !== null && E < o.length && (ct(t, E), o.length = E);
    if (pt() && b !== null && !A && o !== null && (t.f & (T | M | O)) === 0) for (_ = 0; _ < b.length; _++) _n(b[_], t);
    return s !== null && s !== t && (ot++, b !== null && (r === null ? r = b : r.push(...b))), c;
  } finally {
    h = n, E = e, b = r, v = s, S = a, I = f, Dt(u), A = l, t.f ^= Et;
  }
}
function Jn(t, n) {
  let e = n.reactions;
