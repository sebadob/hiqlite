...
function Ze(t, e) {
  if (h) {
    var r = v;
    ((r.f & ye) === 0 || r.nodes.end === null) && (r.nodes.end = f), U();
    return;
  }
  t !== null && t.before(e);
}
...
function X(t, { target: e, anchor: r, props: i = {}, events: s, context: n, intro: a = true }) {
  ...
  var g = void 0, D = ke(() => {
    ...
    return Ce(_, { pending: () => {
      ...
      if (s && (i.$$events = s), h && d(u, null), Y = a, g = t(u, i) || {}, Y = true, h && (v.nodes.end = f, f === null || f.nodeType !== B || f.data !== Se)) throw Le(), M;
      n && De();
    }), () => {
      var _a3;
      for (var u of c) {
